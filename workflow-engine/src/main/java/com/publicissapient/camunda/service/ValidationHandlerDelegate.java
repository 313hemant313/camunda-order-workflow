 ...
 */
public class ValidationHandlerDelegate implements JavaDelegate {

    private final static Logger LOGGER = Logger.getLogger("ValidationHandlerDelegate");

    public void execute(DelegateExecution execution) throws Exception {
        LOGGER.info("Order: '" + execution.getVariable("order") + "' ...");
        LOGGER.info("route: '" + execution.getVariable("route") + "' ...");
        ...
        execution.getProcessEngineServices().getRuntimeService()
                .createMessageCorrelation("OrderFinal")
                .setVariable("orderId", order.getOrderId())
                .setVariable("orderType", order.getOrderType())
                .setVariable("isOrderValid", isOrderValid)
                .setVariable("isOrderConfirmed", true)
                .correlate();
